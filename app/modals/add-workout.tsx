...
const styles = StyleSheet.create({
  ...
  progText: { flex: 1, fontSize: Fs.xs, color: Colors.primary, fontFamily: Fonts.medium },
  progMuted: { color: Colors.textMuted, fontFamily: Fonts.regular },
  progApply: { backgroundColor: Colors.primary, borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
  progApplyText: { fontSize: Fs.xs, color: Colors.onPrimary, fontFamily: Fonts.bold },
  setHeaderRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: Sp.sm, paddingBottom: 4 },
  setHeaderText: { fontSize: Fs.xs, fontFamily: Fonts.regular, color: Colors.textMuted, textAlign: 'center' },
  ...
  addSetBtnText: { fontSize: Fs.xs, fontFamily: Fonts.regular, color: Colors.primary },
  ...
  restBtnText: { fontSize: Fs.xs, fontFamily: Fonts.regular, color: Colors.orange },
  // Flash PR doré
  ...
  sectionHeaderText: { fontSize: Fs.xs, fontFamily: Fonts.bold, color: Colors.primary, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  exercisePickerName: { flex: 1, fontSize: Fs.md, fontFamily: Fonts.regular, color: Colors.text },
  exercisePickerMeta: { fontSize: Fs.xs, fontFamily: Fonts.regular, color: Colors.textMuted },
  // Mode Focus
  ...
  focusBtnText: { fontSize: Fs.xs, color: Colors.orange, fontFamily: Fonts.semibold },
});
...
const smStyles = StyleSheet.create({
  ...
  pillText:    { fontSize: Fs.xs, fontFamily: Fonts.semibold },
  ...
  prsTitle:    { fontSize: Fs.sm, fontFamily: Fonts.bold, color: Colors.yellow, marginBottom: 2 },
  prRow:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  prName:      { fontSize: Fs.xs, fontFamily: Fonts.regular, color: Colors.text, flex: 1 },
...
const focusStyles = StyleSheet.create({
  ...
  progress:    { fontSize: Fs.sm, color: 'rgba(255,255,255,0.4)', fontFamily: Fonts.medium },
  exName:      { fontSize: 36, fontFamily: Fonts.condensedBold, color: '#fff', textAlign: 'center', lineHeight: 44 },
  setInfo:     { fontSize: Fs.xl, color: Colors.primary, marginTop: Sp.md, fontFamily: Fonts.semibold },
  ...
  restTitle:   { fontSize: Fs.md, fontFamily: Fonts.regular, color: 'rgba(255,255,255,0.5)', marginBottom: 4 },
