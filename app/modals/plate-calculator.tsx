...
const styles = StyleSheet.create({
  ...
  label:      { fontSize: Fs.xs, fontWeight: Fw.semibold, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: Sp.md, marginBottom: Sp.sm },
  ...
  fineText:   { fontSize: Fs.sm, color: Colors.textSecondary, fontWeight: Fw.medium },
  ...
  barChipText:{ fontSize: Fs.sm, color: Colors.textSecondary },
  barChipTextActive: { color: Colors.primary, fontWeight: Fw.semibold },
  ...
  resultTitle:{ fontSize: Fs.sm, color: Colors.textSecondary, fontWeight: Fw.semibold, marginBottom: Sp.md, textTransform: 'uppercase', letterSpacing: 0.5 },
  invalidText:{ fontSize: Fs.sm, color: Colors.textMuted, textAlign: 'center', paddingVertical: Sp.md },
  ...
  plateVisualText: { fontSize: 8, fontWeight: Fw.bold, transform: [{ rotate: '-90deg' }], width: 40, textAlign: 'center' },
  ...
  plateChipText: { fontSize: Fs.sm, fontWeight: Fw.bold },
  remainderNote: { fontSize: Fs.xs, color: Colors.orange, marginTop: Sp.md, textAlign: 'center', lineHeight: 17 },

  hint:       { fontSize: Fs.xs, color: Colors.textMuted, marginTop: Sp.lg, textAlign: 'center', lineHeight: 17 },
});
